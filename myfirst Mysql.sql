...
/* Number 7. Output on number 5 whe can say from the output easily we have total count of rating and 
I have also user rating in the other side , I think we can easily calculate the mean value. From this mean value
we can decide something i think */ 
/* Number 8. I have the same insight with number 7 or output 5 */ 
